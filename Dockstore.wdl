...
call runStar { input: read1s = read1s, read2s = read2s, readGroups = readGroups, outputFileNamePrefix = outputFileNamePrefix, docker = docker }
call indexBam { input: inputBam = runStar.outputBam, docker = docker }
